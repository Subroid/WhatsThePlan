...
public class RestaurantsActivity2 extends FragmentActivity implements OnMapReadyCallback {

    //todo all the methods which returns or accepts parameter of Context or Activity

    private static final String TAG = "RestaurantsActivity2Tag";
...
//        initviewsAndVariables ();
    ...
    private Task<LocationSettingsResponse> getLocationSettingsTask() {
        ...
        SettingsClient settingsClient = LocationServices.getSettingsClient(RestaurantsActivity2.this);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED &&
            ...
            ActivityCompat.requestPermissions(RestaurantsActivity2.this, new String[]
                            {Manifest.permission.ACCESS_FINE_LOCATION, Manifest.permission.ACCESS_COARSE_LOCATION},
                    REQUEST_LOCATION_PERMISSIONS_CODE_52);
        } else {
            mMap.setMyLocationEnabled(true);
            mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(RestaurantsActivity2.this);
            Task<Location> taskLastLocation = mFusedLocationProviderClient.getLastLocation();

            taskLastLocation.addOnCompleteListener(RestaurantsActivity2.this, new OnCompleteListener<Location>() {
                @Override
