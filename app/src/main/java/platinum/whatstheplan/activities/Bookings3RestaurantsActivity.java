...
public class Bookings3RestaurantsActivity extends AppCompatActivity {
...
//    private RecyclerView eventsRV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bookings_3_restaurants);
    ...
    private void initViewsAndVariables() {
        ...
        mContext = Bookings3RestaurantsActivity.this;
...
//        fetchBookedEvents(date);
    ...
    private void fetchBookedRestaurants(CalendarDay selectedDate) {
        ...
        BookedRestaurantsAdapter bookedRestaurantsAdapter = new BookedRestaurantsAdapter(getFireStoreRecyclerOptions (query), Bookings3RestaurantsActivity.this, progressBar);
    ...
    /*private void fetchBookedEvents(CalendarDay selectedDate) {
        ...
        BookedEventsAdapter bookedEventsAdapter = new BookedEventsAdapter(getFireStoreRecyclerOptionsEvent (query), Bookings3RestaurantsActivity.this, progressBar);
