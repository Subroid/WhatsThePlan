...
public class PartyEventsActivity extends FragmentActivity implements
        OnMapReadyCallback,
...
//        mRadius = Integer.parseInt(mRadiusET.getText().toString());
    ...
    private void mMapActions() {
        ...
        mapFragment.getMapAsync(PartyEventsActivity.this);
    }
    ...
    private void mPartiesRvActions() {
        ...
        DividerItemDecoration itemDecorator = new DividerItemDecoration
                (PartyEventsActivity.this, DividerItemDecoration.VERTICAL);
        itemDecorator.setDrawable(ContextCompat.getDrawable(PartyEventsActivity.this, R.drawable.divider));
...
//            }
    ...
    public boolean isPlayServicesOK() {
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(PartyEventsActivity.this);
        ...
        if (available == ConnectionResult.SUCCESS) {
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(PartyEventsActivity.this, available, REQUEST_ERROR_DIALOG_CODE_61);
            dialog.show();
        } else {
    ...
    private void requestLocationPermission() {
        ...
        if (ContextCompat.checkSelfPermission(this.getApplicationContext(),
            ...
            ActivityCompat.shouldShowRequestPermissionRationale(PartyEventsActivity.this,
                    android.Manifest.permission.ACCESS_FINE_LOCATION);
...
//        displayPartiesNearUserLocation();
    ...
    private void requestLocationPermissions() {
        ...
        ActivityCompat.requestPermissions(PartyEventsActivity.this, new String[]
...
//                        String timeEventAsText = mEvent.getEvent_time();
                        ...
                        if (mLoopFinished) {
                            ...
                            EventsAdapter eventsAdapter = new EventsAdapter(PartyEventsActivity.this, mEventList, mUserCurrentLocation, mMap, mProgressBarPB);
