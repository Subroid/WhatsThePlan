...
public class OpenEventsActivity extends FragmentActivity implements
    ...
    private RecyclerView mOpenEventsRV;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_openevents);
    ...
    private void initViewsAndVariables() {
        ...
        mFusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(OpenEventsActivity.this);
    }
    ...
    private void mMapActions() {
        ...
        mapFragment.getMapAsync(OpenEventsActivity.this);
    }

    private void mOpenEventsRvActions() {
        Log.d(TAG, "mOpenEventsRvActions: called");
        mOpenEventsRV.setHasFixedSize(true);
        DividerItemDecoration itemDecorator = new DividerItemDecoration
                (OpenEventsActivity.this, DividerItemDecoration.VERTICAL);
        itemDecorator.setDrawable(ContextCompat.getDrawable(OpenEventsActivity.this, R.drawable.divider));
        mOpenEventsRV.addItemDecoration(itemDecorator);
...
//            }
    ...
    public boolean isPlayServicesOK() {
        ...
        int available = GoogleApiAvailability.getInstance().isGooglePlayServicesAvailable(OpenEventsActivity.this);
        ...
        if (available == ConnectionResult.SUCCESS) {
            ...
            Dialog dialog = GoogleApiAvailability.getInstance().getErrorDialog(OpenEventsActivity.this, available, REQUEST_ERROR_DIALOG_CODE_61);
            dialog.show();
        } else {
    ...
    private void requestLocationPermission() {
        ...
        if (ContextCompat.checkSelfPermission(this.getApplicationContext(),
            ...
            ActivityCompat.shouldShowRequestPermissionRationale(OpenEventsActivity.this,
                    Manifest.permission.ACCESS_FINE_LOCATION);
    ...
    private void initMap() {
        mMap.setMapStyle(MapStyleOptions.loadRawResourceStyle(OpenEventsActivity.this, R.raw.style_json));
            ...
            taskLastLocation.addOnCompleteListener(new OnCompleteListener<Location>() {
                ...
                public void onComplete(@NonNull Task<Location> task) {
                    if (task.isSuccessful() && task.getResult() != null) {
                        ...
                        setUserMarker();
                        saveUserLocationIntoFirestoreThenDisplayOpenEventsNearUserLocation();
    ...
    private void setUserMarker() {
        ...
        mUserMarker = mMap.addMarker(new MarkerOptions()
                .position(latLng)
                .title("You are here")
                .snippet("Find OpenEvents around you"));
    ...
    private void addOnMyLocationButtonClickListener() {
        ...
        mMap.setOnMyLocationButtonClickListener(new GoogleMap.OnMyLocationButtonClickListener() {
            ...
            public boolean onMyLocationButtonClick() {
                ...
                if (ActivityCompat.checkSelfPermission(OpenEventsActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
                    requestLocationPermissions();
    ...
    private void saveUserLocationIntoFirestoreThenDisplayOpenEventsNearUserLocation() {
        saveUserLocationIntoFirestore();
        displayOpenEventsNearUserLocation(mRadius);
//        displayOpenEventsWithin5km();
//        displayOpenEventsNearUserLocation();
    }
    ...
    private void displayOpenEventsNearUserLocation(int radius) {
        mKeyList.clear();
        mEventList.clear();
        Log.d(TAG, "displayOpenEventsNearUserLocation: radius = " + radius);
                ...
                mDbFirestore.collection("OpenEvents").document(key).get().addOnSuccessListener(new OnSuccessListener<DocumentSnapshot>() {
                    ...
                    public void onSuccess(DocumentSnapshot documentSnapshot) {
                        ...
                        if (mLoopFinished) {
                            ...
                            hideSoftKeyboard(OpenEventsActivity.this, mRadiusET);
